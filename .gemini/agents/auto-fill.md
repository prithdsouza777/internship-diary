---
name: auto-fill
description: "Use this agent to run the VTU internship portal auto-fill script (auto_fill.py). Executes the Selenium-based form filler that reads the latest diary entry from Internship_Diary.md and submits it to the VTU portal."
tools:
  - run_shell_command
---

# VTU Portal Auto-Fill Agent

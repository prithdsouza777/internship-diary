...
description: "Use this agent after a diary entry is written to check if the active project file needs updating. Also invoke when the user mentions milestone completions, tech stack changes, or explicitly says 'update context'."
tools:
  - read_file
  - replace
  - glob

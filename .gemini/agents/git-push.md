---
name: git-push
description: "Use this agent to commit and push Internship_Diary.md to the remote git repository. Runs automatically after diary entries are written. Stages ONLY Internship_Diary.md, commits with the date as the message, pushes to origin main."
tools:
  - run_shell_command
---
